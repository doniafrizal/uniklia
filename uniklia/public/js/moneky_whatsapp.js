...
if(!erpnext.common_SMSManager){
	erpnext.common_SMSManager = erpnext.SMSManager;
}


erpnext.SMSManager = function(doc) {
	var me = this;
	this.setup = function() {
		var default_msg = {
			'Lead'				: '',
		...
		d.fields_dict.send.input.onclick = function() {
			...
			if(v) {
				...
				if(d.fields_dict.type.value == "Whatsapp"){
					correct_method = "whatsapp_integration.api.send_whatsapp";
